...
class Parsedown
{
    ...
    protected function inlineLink($Excerpt)
    {
        ...
        $target = $this->getLinkTarget($Element['attributes']['href']);
    ...
    protected function getLinkTarget($url)
    {
        if (substr($url, 0, 1) === '/')
        {
            return '_self';
        ...
        if (strpos($url, '://') !== false)
        {
            ...
            if (isset($urlParts['host']) and $urlParts['host'] !== $_SERVER['HTTP_HOST'])
            {
                return '_blank';
            }
        }
    ...
    protected function inlineUrl($Excerpt)
    {
        ...
        if (strpos($Excerpt['context'], 'http') !== false
            ...
            $url = $matches[0][0];
            $target = substr($url, 0, 1) === '/' ? '_self' : '_blank';
            $Inline = array(
	...
	public $SERVER_NAME = "comments.natfrp.org";
